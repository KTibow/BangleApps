...
function reading() {
    ...
    // display
    buf.setFont('6x8', 2);
    buf.drawString("BX: " + m.dy, 20, 0);
    buf.drawString("X: " + Math.floor(g.y * 1000), 120, 0);
    buf.drawString("BY: " + m.dx, 20, 20);
    buf.drawString("Y: " + Math.floor(-g.x * 1000), 120, 20);
    buf.drawString("BZ: " + m.dz, 20, 40);
    buf.drawString("Z: " + Math.floor(-g.z * 1000), 120, 40);
