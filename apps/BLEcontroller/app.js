...
var status_light_hall = {
    value: false
};
var status_light_study = {
    value: false
};
...
const drawScreen = (params) => {
    ...
    g.setColor(0x000);
    if (params.btn1) {
        g.drawImage(drawIcon(params.btn1), 210, 40);
    }
    if (params.btn2) {
        g.drawImage(drawIcon(params.btn2), 210, 125);
    }
    if (params.btn3) {
        g.drawImage(drawIcon(params.btn3), 210, 195);
    }
};
