...
var locales = {
    ...
    "en_CA": {
        ...
        datePattern: {
            0: "%A, %B %d, %Y",
            "1": "%Y-%m-%d"
        }, //  Sunday, March 1, 2020  // 2012-12-20
        abmonth: "Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec",
        month: "January,February,March,April,May,June,July,August,September,October,November,December",
        abday: "Sun,Mon,Tue,Wed,Thu,Fri,Sat",
        day: "Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday",
    ...
    "fr_FR": {
        ...
        datePattern: {
            0: "%A %d %B %Y",
            "1": "%d/%m/%Y"
        }, // dimanche 1 mars 2020 //  01/03/2020
    ...
    "en_IL": {
        ...
        datePattern: {
            0: "%A, %B %d, %Y",
            "1": "%d/%m/%Y"
        }, //  Sunday, 1 March 2020  // 01/03/2020
        abmonth: "Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec",
        month: "January,February,March,April,May,June,July,August,September,October,November,December",
        abday: "Sun,Mon,Tue,Wed,Thu,Fri,Sat",
        day: "Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday",
    ...
    "es_ES": {
        ...
        datePattern: {
            0: "%A, %d de %B de %Y",
            "1": "%d/%m/%y"
        }, //  domingo, 1 de marzo de 2020  // 01/03/20
    ...
    "fi_FI": {
        ...
        datePattern: {
            0: "%A %d. %B %Y",
            "1": "%-d/%-m/%Y"
        }, // sunnuntai 1. maaliskuuta 2020 // 1.3.2020
    ...
    "wae_CH": {
        ...
        datePattern: {
            0: "%A, %d. %B %Y",
            "1": "%Y-%m-%d"
        }, // Sunntag, 1. Märze 2020 //  2020-03-01
    ...
    "hu_HU": {
        ...
        datePattern: {
            0: "%Y %b %d, %A",
            1: "%Y.%m.%d"
        }, // 2020 Feb 28, Péntek" // "2020.03.01."(short)
    ...
    "oc_FR": {
        ...
        datePattern: {
            0: "%A %d %B de %Y",
            "1": "%d/%m/%Y"
        }, // dimenge 1 de març de 2020 //  01/03/2020
