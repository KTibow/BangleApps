...
var qrcode = function() {
    ...
    function f(h, b, e) {
        ...
        this.__defineGetter__("NumBlocks",
            function() {
                for (var d = 0, c = 0; c < this.ecBlocks.length; c++) d += this.ecBlocks[c].length;
                return d
            });
    ...
    function k(h, b, e, d, c, a) {
        ...
        e = e.getECBlocks();
        for (d = 0; d < e.length; d++) c = e[d], h += c.Count * (c.DataCodewords + b);
        ...
        this.buildFunctionPattern = function() {
            ...
            for (var e = this.alignmentPatternCenters.length, b = 0; b < e; b++)
                for (var a = this.alignmentPatternCenters[b] - 2, h = 0; h < e; h++) 0 == b && (0 == h || h == e - 1) || b == e - 1 && 0 == h || c.setRegion(this.alignmentPatternCenters[h] -
                    2, a, 5, 5);
    ...
    function Q(h) {
        ...
        this.sizeOfBlackWhiteBlackRun = function(b, e, d, c) {
            ...
            for (var m = Math.abs(d - b), f = Math.abs(c - e), q = -m >> 1, k = e < c ? 1 : -1, x = b < d ? 1 : -1, v = 0, t = b, a = e; t != d; t += x) {
                ...
                if (3 == v) return c = t - b, e = a - e, Math.sqrt(c *
                    c + e * e);
                q += f;
                if (0 < q) {
                    if (a == c) break;
        ...
        this.calculateModuleSizeOneWay = function(b, e) {
            var d = this.sizeOfBlackWhiteBlackRunBothWays(Math.floor(b.X),
                    Math.floor(b.Y), Math.floor(e.X), Math.floor(e.Y)),
        ...
        this.createTransform = function(b, e, d, c, h) {
            ...
            return z.quadrilateralToQuadrilateral(3.5,
        ...
        this.processFinderPatternInfo = function(b) {
            ...
            if (0 < a.AlignmentPatternCenters.length)
                for (a = 1 - 3 / m, f = Math.floor(e.X + a * (d.X - e.X + b.X - e.X)), a = Math.floor(e.Y + a * (d.Y - e.Y + b.Y - e.Y));;) {
    ...
    function I(h, b) {
        ...
        this.setRegion = function(d, c, e, b) {
            ...
            for (; c < b; c++)
                for (var h = c * this.rowSize, a = d; a < e; a++) this.bits[h + (a >> 5)] |= 1 << (a & 31)
        }
    }
    ...
    function T(a) {
        ...
        this.readFormatInformation = function() {
            ...
            for (var e =
                    0, d = 0; 6 > d; d++) e = this.copyBit(d, 8, e);
            ...
            if (null != this.parsedFormatInfo) return this.parsedFormatInfo;
            for (var c = this.bitMatrix.Dimension, e = 0, b = c - 8, d = c - 1; d >= b; d--) e = this.copyBit(d, 8, e);
        ...
        this.readVersion = function() {
            ...
            this.parsedVersion = k.decodeVersionInformation(d);
            if (null !=
                this.parsedVersion && this.parsedVersion.DimensionForVersion == e) return this.parsedVersion;
        ...
        this.readCodewords = function() {
            ...
            for (var c = d.buildFunctionPattern(), a = !0, h = Array(d.TotalCodewords), m = 0, f = 0, g = 0, k = b - 1; 0 < k; k -= 2) {
                6 == k && k--;
                for (var x = 0; x < b; x++)
                    for (var v = a ? b - 1 - x : x, t = 0; 2 > t; t++) c.get_Renamed(k - t, v) || (g++, f <<= 1, this.bitMatrix.get_Renamed(k -
                        t, v) && (f |= 1), 8 == g && (h[m++] = f, f = g = 0));
                a ^= 1
            }
    ...
    function w(a, b) {
        ...
        if (1 < e && 0 == b[0]) {
            ...
            if (d == e) this.coefficients = a.Zero.coefficients;
                ...
                for (e = 0; e < this.coefficients.length; e++) this.coefficients[e] = b[d + e]
            }
        ...
        this.evaluateAt = function(c) {
            ...
            if (1 == c) {
                for (var b = c = 0; b < d; b++) c = n.addOrSubtract(c, this.coefficients[b]);
                return c
            }
            for (var e = this.coefficients[0], b = 1; b <
                d; b++) e = n.addOrSubtract(this.field.multiply(c, e), this.coefficients[b]);
            return e
        };
        this.addOrSubtract = function(c) {
            ...
            for (var b = Array(c.length), e = c.length - d.length, h = 0; h < e; h++) b[h] = c[h];
        ...
        this.multiply1 = function(c) {
            ...
            for (var e = c.length, a = Array(b + e - 1), h = 0; h < b; h++)
                for (var f = d[h], g = 0; g < e; g++) a[h + g] = n.addOrSubtract(a[h + g], this.field.multiply(f, c[g]));
            return new w(this.field, a)
        };
        this.multiply2 = function(c) {
            if (0 == c) return this.field.Zero;
            if (1 == c) return this;
            for (var d = this.coefficients.length, b = Array(d), e = 0; e < d; e++) b[e] = this.field.multiply(this.coefficients[e], c);
            return new w(this.field, b)
        };
        this.multiplyByMonomial = function(c,
            d) {
            if (0 > c) throw "System.ArgumentException";
            if (0 == d) return this.field.Zero;
            for (var b = this.coefficients.length, e = Array(b + c), a = 0; a < e.length; a++) e[a] = 0;
            for (a = 0; a < b; a++) e[a] = this.field.multiply(this.coefficients[a], d);
            return new w(this.field, e)
        };
        this.divide = function(c) {
            if (this.field != c.field) throw "GF256Polys do not have same GF256 field";
            if (c.Zero) throw "Divide by 0";
            for (var d = this.field.Zero, b = this, e = c.getCoefficient(c.Degree), e = this.field.inverse(e); b.Degree >= c.Degree && !b.Zero;) var a = b.Degree - c.Degree,
    ...
    function n(a) {
        ...
        for (var b = 1, e = 0; 256 > e; e++) this.expTable[e] = b, b <<= 1, 256 <= b && (b ^= a);
    ...
    function S() {
        ...
        this.foundPatternCross = function(a) {
            ...
            b = Math.floor((b << D) / 7);
            e = Math.floor(b / 2);
            return Math.abs(b - (a[0] << D)) < e && Math.abs(b -
        ...
        this.crossCheckVertical = function(a, b, e, d) {
            for (var c = this.image, h = g.height, l = this.CrossCheckStateCount, m = a; 0 <= m && c[b + m * g.width];) l[2]++, m--;
            if (0 > m) return NaN;
        ...
        this.crossCheckHorizontal = function(a, b, e, d) {
            for (var c = this.image, h = g.width, l = this.CrossCheckStateCount, m = a; 0 <= m && c[m + b * g.width];) l[2]++, m--;
            if (0 > m) return NaN;
            for (; 0 <= m && !c[m + b * g.width] && l[1] <= e;) l[1]++, m--;
            if (0 > m || l[1] > e) return NaN;
            for (; 0 <= m && c[m + b * g.width] && l[0] <=
                e;) l[0]++, m--;
            if (l[0] > e) return NaN;
        ...
        this.handlePossibleCenter = function(a, b, e) {
            ...
            if (!isNaN(b) && (e = this.crossCheckHorizontal(Math.floor(e),
                    Math.floor(b), a[2], d), !isNaN(e))) {
                a = d / 7;
        ...
        this.selectBestPatterns = function() {
            ...
            if (3 < a) {
                for (var b = 0, e = 0, d = 0; d < a; d++) var c =
                    this.possibleCenters[d].EstimatedModuleSize,
                    b = b + c,
                    e = e + c * c;
                var p = b / a;
                ...
                for (d = this.possibleCenters.length - 1; 0 <= d; d--) Math.abs(this.possibleCenters[d].EstimatedModuleSize - p) > a && this.possibleCenters.splice(d, 1)
            }
        ...
        this.findRowSkip = function() {
            ...
            for (var b = null, e = 0; e < a; e++) {
                ...
                if (d.Count >= K)
                    if (null == b) b = d;
                    else return this.hasSkipped = !0, Math.floor((Math.abs(b.X - d.X) - Math.abs(b.Y - d.Y)) / 2)
            }
            return 0
        };
        this.haveMultiplyConfirmedCenters = function() {
            ...
            if (3 > b) return !1;
            for (var b = e / d, p = 0, c = 0; c < d; c++) a = this.possibleCenters[c], p += Math.abs(a.EstimatedModuleSize - b);
            return p <= .05 * e
        };
                    ...
                    if (4 == b)
                        if (this.foundPatternCross(l)) {
                            if (b = this.handlePossibleCenter(l, m, f)) c = 2, this.hasSkipped ? h = this.haveMultiplyConfirmedCenters() :
                                (b = this.findRowSkip(), b > l[2] && (m += b - l[2] - c, f = d - 1));
                            else {
                                do f++; while (f < d && !a[f + m * g.width]);
                                f--
                            }
                            b = 0;
                            l[0] = 0;
    ...
    function R(a, b, e, d, c, f, l) {
        ...
        this.handlePossibleCenter = function(c, d, b) {
            ...
            if (!isNaN(d)) {
                c = (c[0] + c[1] + c[2]) / 3;
                for (var a = this.possibleCenters.length,
                        e = 0; e < a; e++)
                ...
                for (c = 0; A < f;) {
                    if (a[A + n * g.width])
                        ...
                        if (this.foundPatternCross(p) &&
                            (c = this.handlePossibleCenter(p, n, A), null != c)) return c;
                        p[0] = p[2];
                        p[1] = 1;
                        p[2] = 0;
                        c = 1
    ...
    function X(a, b, e) {
        ...
        9 >= b ? this.dataLengthMode = 0 : 10 <= b && 26 >= b ? this.dataLengthMode = 1 : 27 <=
            b && 40 >= b && (this.dataLengthMode = 2);
        this.getNextBits = function(b) {
            ...
            if (b < this.bitPointer + 1 + 8) {
                ...
                this.bitPointer -= b % 8;
                0 > this.bitPointer && (this.bitPointer =
                    8 + this.bitPointer);
                return d
            }
            ...
            do
                if (1 < b) {
                    ...
                    var e = a % 45,
                        ...
                        c = c + d[e];
                    b -= 2
                } else 1 == b && (a = this.getNextBits(6), c += d[a], --b); while (0 <
                b);
            return c
        };
        this.getFigureString = function(b) {
            var c = 0,
                d = "";
            do 3 <= b ? (c = this.getNextBits(10), 100 > c && (d += "0"), 10 > c && (d += "0"), b -= 3) : 2 == b ? (c = this.getNextBits(7), 10 > c && (d += "0"), b -= 2) : 1 == b && (c = this.getNextBits(4), --b), d += c; while (0 < b);
            return d
        };
                ...
                if (7 == c) this.parseECIValue();
                    ...
                    switch (c) {
                        case 1:
                            ...
                            for (var a = Array(c.length), e = 0; e < c.length; e++) a[e] = c.charCodeAt(e);
                            b.push(a);
                            break;
                        case 2:
    ...
    var F = {
        checkAndNudgePoints: function(a, b) {
            for (var e, d, c = g.width, h = g.height, f = !0, m = 0; m < b.length && f; m += 2) {
                ...
                f = !1; - 1 == d ? (b[m] = 0, f = !0) : d == c && (b[m] = c - 1, f = !0); - 1 == e ? (b[m + 1] = 0, f = !0) : e == h && (b[m + 1] = h - 1, f = !0)
            }
            f = !0;
        ...
        sampleGrid3: function(a, b, e) {
            for (var d = new I(b), c = Array(b << 1), h = 0; h < b; h++) {
                for (var f =
                        c.length, m = h + .5, k = 0; k < f; k += 2) c[k] = (k >> 1) + .5, c[k + 1] = m;
                e.transformPoints1(c);
                F.checkAndNudgePoints(a, c);
                try {
                    for (k = 0; k < f; k += 2) a[Math.floor(c[k]) + g.width * Math.floor(c[k + 1])] && d.set_Renamed(k >> 1, h)
                } catch (q) {
        ...
        sampleGridx: function(a, b, e, d, c, f, l, g, k, q, n, x, v, t, r, A, u, w) {
    ...
    k.VERSION_DECODE_INFO = [31892, 34236, 39577, 42195, 48118, 51042, 55367, 58893, 63784, 68472, 70749, 76311, 79154,
        84390, 87683, 92361, 96236, 102084, 102881, 110507, 110734, 117786, 119615, 126325, 127568, 133589, 136944, 141498, 145311, 150283, 152622, 158308, 161089, 167017
    ];
    k.VERSIONS = [new k(1, [], new f(7, new a(1, 19)), new f(10, new a(1, 16)), new f(13, new a(1, 13)), new f(17, new a(1, 9))), new k(2, [6, 18], new f(10, new a(1, 34)), new f(16, new a(1, 28)), new f(22, new a(1, 22)), new f(28, new a(1, 16))), new k(3, [6, 22], new f(15, new a(1, 55)), new f(26, new a(1, 44)), new f(18, new a(2, 17)), new f(22, new a(2, 13))), new k(4, [6, 26], new f(20, new a(1, 80)), new f(18,
        ...
        new k(12, [6, 32, 58], new f(24, new a(2, 92), new a(2, 93)), new f(22, new a(6, 36), new a(2, 37)), new f(26, new a(4, 20), new a(6, 21)), new f(28, new a(7, 14), new a(4, 15))), new k(13, [6, 34, 62], new f(26, new a(4, 107)), new f(22, new a(8, 37), new a(1, 38)), new f(24, new a(8, 20), new a(4, 21)), new f(22, new a(12, 11), new a(4, 12))), new k(14, [6, 26, 46, 66], new f(30, new a(3, 115), new a(1, 116)), new f(24, new a(4, 40), new a(5, 41)), new f(20, new a(11, 16), new a(5, 17)), new f(24, new a(11, 12), new a(5, 13))), new k(15, [6, 26, 48, 70], new f(22, new a(5,
            ...
            166
        ], new f(30, new a(20, 117), new a(4, 118)), new f(28, new a(40, 47), new a(7, 48)), new f(30, new a(43, 24), new a(22, 25)), new f(30, new a(10, 15), new a(67, 16))), new k(40, [6, 30, 58, 86, 114, 142, 170], new f(30, new a(19, 118), new a(6, 119)), new f(28, new a(18, 47), new a(31, 48)), new f(30, new a(34, 24), new a(34, 25)), new f(30, new a(20, 15), new a(61, 16)))
    ];
    ...
    z.quadrilateralToQuadrilateral = function(a, b, e, d, c, f, g, m, k, q, n, x, v, t, r, u) {
        ...
        return this.squareToQuadrilateral(k,
    ...
    G.getDataBlocks = function(a, b, e) {
        ...
        for (b = d; b < k; b++)
            for (f = 0; f <
                h; f++) e[f].codewords[f < c ? b : b + 1] = a[g++];
        return e
    };
    var H = {
    ...
    H.DATA_MASKS = [new function() {
        ...
        new function() {
            this.unmaskBitMatrix = function(a, b) {
                for (var e = 0; e < b; e++)
                    for (var d = 0; d < b; d++) this.isMasked(e, d) && a.flip(d,
                        e)
            };
            this.isMasked = function(a, b) {
    ...
    E.rsDecoder = new function(a) {
        ...
        this.decode = function(a, e) {
            for (var b = new w(this.field, a), c = Array(e), f = 0; f < c.length; f++) c[f] = 0;
            ...
            if (!h)
                for (f = new w(this.field, c), b = this.runEuclideanAlgorithm(this.field.buildMonomial(e, 1), f, e), f = b[1],
                    b = this.findErrorLocations(b[0]), c = this.findErrorMagnitudes(f, b, !1), f = 0; f < b.length; f++) {
        ...
        this.findErrorLocations = function(a) {
            var b = a.Degree;
            if (1 ==
                b) return Array(a.getCoefficient(1));
            for (var d = Array(b), c = 0, f = 1; 256 > f && c < b; f++) 0 == a.evaluateAt(f) && (d[c] = this.field.inverse(f), c++);
        ...
        this.findErrorMagnitudes = function(a, e, d) {
            for (var b = e.length, f = Array(b), h = 0; h < b; h++) {
                for (var g = this.field.inverse(e[h]), k = 1, q = 0; q < b; q++) h != q && (k = this.field.multiply(k, n.addOrSubtract(1, this.field.multiply(e[q], g))));
                f[h] = this.field.multiply(a.evaluateAt(g), this.field.inverse(k));
                d && (f[h] = this.field.multiply(f[h],
                    g))
            }
            return f
        }
    ...
    E.decode = function(a) {
        var b = new T(a);
        a = b.readVersion();
        for (var e = b.readFormatInformation().ErrorCorrectionLevel, b = b.readCodewords(), b = G.getDataBlocks(b, a, e), d = 0, c = 0; c < b.length; c++) d += b[c].NumDataCodewords;
    ...
    var g = {
            ...
            decode: function(a) {
                if (0 == arguments.length) {
                    ...
                    null !=
                        g.callback && g.callback(g.result);
                    return g.result
                }
                var d = new Image;
            ...
            process: function(a) {
                ...
                if (g.debug) {
                    for (d = 0; d < e.bits.Height; d++)
                        for (c = 0; c < e.bits.Width; c++) f = 8 * c + 2 * d * g.width * 4, g.imagedata.data[f] = (e.bits.get_Renamed(c, d), 0), g.imagedata.data[f + 1] = (e.bits.get_Renamed(c, d), 0), g.imagedata.data[f + 2] = e.bits.get_Renamed(c, d) ? 255 : 0;
                    a.putImageData(g.imagedata, 0, 0)
                }
            ...
            getMiddleBrightnessPerArea: function(a) {
                ...
                for (c = 0; 4 > c; c++)
                    for (f = 0; 4 > f; f++) a[f][c] = Math.floor((d[f][c][0] + d[f][c][1]) / 2);
                return a
            },
            grayScaleToBitmap: function(a) {
                for (var b = g.getMiddleBrightnessPerArea(a), e = b.length, d = Math.floor(g.width / e), c = Math.floor(g.height / e), f = new ArrayBuffer(g.width * g.height), f = new Uint8Array(f), h = 0; h < e; h++)
                    for (var m = 0; m < e; m++)
                        for (var k =
                                0; k < c; k++)
                            for (var n = 0; n < d; n++) f[d * m + n + (c * h + k) * g.width] = a[d * m + n + (c * h + k) * g.width] < b[m][h] ? !0 : !1;
                return f
            },
            grayscale: function() {
    ...
    g.orderBestPatterns = function(a) {
        ...
        var e = b(a[0], a[1]),
            d = b(a[1], a[2]),
            c = b(a[0], a[2]);
        d >= e && d >= c ? (d = a[0], e = a[1], c = a[2]) : c >= d && c >= e ? (d = a[1],
            e = a[0], c = a[2]) : (d = a[2], e = a[0], c = a[1]);
        if (0 > function(a, b, c) {
                var d = b.x;
                b = b.y;
