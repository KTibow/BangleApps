...
var buf1 = Graphics.createArrayBuffer(160, 160, 1, {
    msb: true
});
var buf2 = Graphics.createArrayBuffer(80, 40, 1, {
    msb: true
});
...
function drawCompass(course) {
    ...
    buf1.setColor(1);
    buf1.drawImage(arrow_img, 80, 80, {
        scale: 3,
...
function setButtons() {
    setWatch(nextwp.bind(null, -1), BTN1, {
        repeat: true,
        edge: "falling"
    });
    setWatch(doselect, BTN2, {
        repeat: true,
        edge: "falling"
    });
    setWatch(nextwp.bind(null, 1), BTN3, {
        repeat: true,
        edge: "falling"
    });
}
