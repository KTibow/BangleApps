...
function setGPSTime() {
    if (fix.time !== undefined) {
        ...
        E.showMessage("System time set", {
            img: require("heatshrink").decompress(atob(""))
        });
    } else {
