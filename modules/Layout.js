    ...
    if (options.btns) {
        ...
        if (this.physBtns >= buttons.length) {
            ...
            if (this.physBtns > 2 && buttons.length == 1)
                buttons.unshift({
                    label: ""
                }); // pad so if we have a button in the middle
            ...
            this._l = {
                ...
                c: [
                    this._l,
                    {
                        ...
                        pad: 1,
                        filly: 1,
                        c: buttons.map(b => (b.type = "txt", b.font = "6x8", b.height = btnHeight, b.r = 1, b))
                    }
                ]
            };
        } else {
            ...
            this._l = {
                ...
                c: [
                    ...
                    {
                        type: "v",
                        c: buttons.map(b => (b.type = "btn", b.filly = 1, b.width = 32, b.r = 1, b))
                    }
                ]
            };
...
function prepareLazyRender(l, rectsToClear, drawList, rects, parentBg) {
    ...
    if (l.c)
        for (var ch of l.c) prepareLazyRender(ch, rectsToClear, drawList, rects, bgCol);
}
    ...
    var cb = {
        ...
        "img": function(l) {
            var m = g.imageMetrics("function" == typeof l.src ? l.src() : l.src),
                s = l.scale || 1; // get width and height out of image
            l._w = m.width * s;
            l._h = m.height * s;
        },
        "": function(l) {
